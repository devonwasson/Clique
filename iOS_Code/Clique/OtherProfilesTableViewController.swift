//
//  OtherProfilesTableViewController.swift
//  Clique
//
...
class OtherProfilesTableViewController: UITableViewController {
    
    var connection = Connection()
    //var locations = [1,1,1,1,1]
    ...
    override func tableView(tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return connection.placesTimePairs.count + 2
    }
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        if indexPath.row == 0{
            let topCell = tableView.dequeueReusableCellWithIdentifier("otherProfileTopCell", forIndexPath: indexPath) as! OtherProfileTopCell
            topCell.connection = self.connection
            topCell.updateCell()
