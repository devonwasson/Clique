    ...
    */
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        if indexPath.row % 2 == 0{
            return tableView.dequeueReusableCellWithIdentifier("messageLeftCell", forIndexPath: indexPath) as! MessageLeftTableViewCell
        }
        else{
            return tableView.dequeueReusableCellWithIdentifier("messageRightCell", forIndexPath: indexPath) as! MessageRightTableViewCell
        }
